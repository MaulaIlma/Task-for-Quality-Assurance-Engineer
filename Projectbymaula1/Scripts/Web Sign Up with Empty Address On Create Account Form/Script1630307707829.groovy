...
WebUI.setText(findTestObject('Object Repository/Page_Login - My Store/input_Email address_email_create'), 'testkatahariini9@mailsac.com')
...
WebUI.verifyElementPresent(findTestObject('Page_Login - My Store/Message error address1 is required'), 0)
