...
WebUI.setText(findTestObject('Object Repository/Page_Login - My Store/input_Email address_email_create'), 'testkatahariini8@mailsac.com')
...
WebUI.verifyElementPresent(findTestObject('Page_Login - My Store/Message error city is required'), 0)
