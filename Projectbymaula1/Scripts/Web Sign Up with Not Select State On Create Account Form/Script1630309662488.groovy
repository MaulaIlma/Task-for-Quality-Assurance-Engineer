...
WebUI.setText(findTestObject('Object Repository/Page_Login - My Store/input_Email address_email_create'), 'testkatahariini2@mailsac.com')
...
WebUI.verifyElementPresent(findTestObject('Page_Login - My Store/Message error This country requires you to choose a State'), 
    0)
