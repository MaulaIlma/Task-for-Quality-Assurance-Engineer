...
WebUI.setText(findTestObject('Object Repository/Page_Login - My Store/input_Email address_email_create'), 'testkatahariini4@mailsac.com')
...
WebUI.click(findTestObject('Page_Login - My Store/p_State --AlabamaAlaskaArizonaArkansasCalif_c49684'))
...
WebUI.verifyElementPresent(findTestObject('Page_Login - My Store/Message error password empty'), 0)
